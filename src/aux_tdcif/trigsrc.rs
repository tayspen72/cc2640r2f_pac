...
Polarity of stop source. Change only while STAT.STATE is IDLE."]
pub struct STOP_POL_R(crate::FieldReader<bool, STOP_POL_A>);
impl STOP_POL_R {
    pub(crate) fn new(bits: bool) -> Self {
        STOP_POL_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for STOP_POL_R {
    type Target = crate::FieldReader<bool, STOP_POL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> STOP_POL_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: STOP_POL_A) -> &'a mut W {
...
Select stop source from the asynchronous AUX event bus. Change only while STAT.STATE is IDLE."]
pub struct STOP_SRC_R(crate::FieldReader<u8, STOP_SRC_A>);
impl STOP_SRC_R {
    pub(crate) fn new(bits: u8) -> Self {
        STOP_SRC_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for STOP_SRC_R {
    type Target = crate::FieldReader<u8, STOP_SRC_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> STOP_SRC_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: STOP_SRC_A) -> &'a mut W {
