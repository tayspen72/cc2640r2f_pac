...
pub struct SEC_THRESHOLD_R(crate::FieldReader<u32, u32>);
impl SEC_THRESHOLD_R {
    pub(crate) fn new(bits: u32) -> Self {
        SEC_THRESHOLD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SEC_THRESHOLD_R {
