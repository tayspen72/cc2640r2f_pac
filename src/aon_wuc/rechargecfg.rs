...
pub struct ADAPTIVE_EN_R(crate::FieldReader<bool, bool>);
impl ADAPTIVE_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        ADAPTIVE_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADAPTIVE_EN_R {
...
pub struct MAX_PER_M_R(crate::FieldReader<u8, u8>);
impl MAX_PER_M_R {
    pub(crate) fn new(bits: u8) -> Self {
        MAX_PER_M_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MAX_PER_M_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
This register defines the maximum period that the recharge algorithm can take, i.e. it defines the maximum number of cycles between 2 recharges. The maximum number of cycles is specified with a 5 bit mantissa and 3 bit exponent: MAXCYCLES=(MAX_PER_M*16+15)*2^MAX_PER_E This field sets the exponent MAXCYCLES"]
pub struct MAX_PER_E_R(crate::FieldReader<u8, u8>);
impl MAX_PER_E_R {
    pub(crate) fn new(bits: u8) -> Self {
        MAX_PER_E_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MAX_PER_E_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
