...
Internal. Only to be used through TI provided API."]
pub struct PATRIMCOMPLETE_N_R(crate::FieldReader<bool, bool>);
impl PATRIMCOMPLETE_N_R {
    pub(crate) fn new(bits: bool) -> Self {
        PATRIMCOMPLETE_N_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PATRIMCOMPLETE_N_R {
