...
pub struct RegisterBlock {
    ...
    pub evflags: crate::Reg<evflags::EVFLAGS_SPEC>,
    ...
    pub chctl: crate::Reg<chctl::CHCTL_SPEC>,
    #[doc = "0x18 - Channel 0 Compare Value"]
    pub ch0cmp: crate::Reg<ch0cmp::CH0CMP_SPEC>,
    #[doc = "0x1c - Channel 1 Compare Value"]
    pub ch1cmp: crate::Reg<ch1cmp::CH1CMP_SPEC>,
    #[doc = "0x20 - Channel 2 Compare Value"]
    pub ch2cmp: crate::Reg<ch2cmp::CH2CMP_SPEC>,
...
event."]
    pub ch2cmpinc: crate::Reg<ch2cmpinc::CH2CMPINC_SPEC>,
    ...
    pub ch1capt: crate::Reg<ch1capt::CH1CAPT_SPEC>,
...
pub mod ctl;
#[doc = "EVFLAGS register accessor: an alias for `Reg<EVFLAGS_SPEC>`"]
...
pub mod subsecinc;
#[doc = "CHCTL register accessor: an alias for `Reg<CHCTL_SPEC>`"]
pub type CHCTL = crate::Reg<chctl::CHCTL_SPEC>;
#[doc = "Channel Configuration"]
pub mod chctl;
#[doc = "CH0CMP register accessor: an alias for `Reg<CH0CMP_SPEC>`"]
pub type CH0CMP = crate::Reg<ch0cmp::CH0CMP_SPEC>;
#[doc = "Channel 0 Compare Value"]
pub mod ch0cmp;
#[doc = "CH1CMP register accessor: an alias for `Reg<CH1CMP_SPEC>`"]
pub type CH1CMP = crate::Reg<ch1cmp::CH1CMP_SPEC>;
#[doc = "Channel 1 Compare Value"]
pub mod ch1cmp;
#[doc = "CH2CMP register accessor: an alias for `Reg<CH2CMP_SPEC>`"]
pub type CH2CMP = crate::Reg<ch2cmp::CH2CMP_SPEC>;
#[doc = "Channel 2 Compare Value"]
pub mod ch2cmp;
#[doc = "CH2CMPINC register accessor: an alias for `Reg<CH2CMPINC_SPEC>`"]
...
event."]
pub mod ch2cmpinc;
#[doc = "CH1CAPT register accessor: an alias for `Reg<CH1CAPT_SPEC>`"]
