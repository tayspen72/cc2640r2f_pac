...
pub struct B1_MAX_SECTOR_R(crate::FieldReader<u8, u8>);
impl B1_MAX_SECTOR_R {
    pub(crate) fn new(bits: u8) -> Self {
        B1_MAX_SECTOR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for B1_MAX_SECTOR_R {
...
Internal. Only to be used through TI provided API."]
pub struct B1_MUX_FACTOR_R(crate::FieldReader<u8, u8>);
impl B1_MUX_FACTOR_R {
    pub(crate) fn new(bits: u8) -> Self {
        B1_MUX_FACTOR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for B1_MUX_FACTOR_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
Internal. Only to be used through TI provided API."]
pub struct B1_START_ADDR_R(crate::FieldReader<u32, u32>);
impl B1_START_ADDR_R {
    pub(crate) fn new(bits: u32) -> Self {
        B1_START_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for B1_START_ADDR_R {
