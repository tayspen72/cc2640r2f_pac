...
Select active polarity for START_SRC event."]
pub struct START_POL_R(crate::FieldReader<bool, START_POL_A>);
impl START_POL_R {
    pub(crate) fn new(bits: bool) -> Self {
        START_POL_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for START_POL_R {
    type Target = crate::FieldReader<bool, START_POL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> START_POL_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: START_POL_A) -> &'a mut W {
...
Select ADC trigger event source from the asynchronous AUX event bus. Set START_SRC to NO_EVENT<n> if you want to trigger the ADC manually through ADCTRIG.START."]
pub struct START_SRC_R(crate::FieldReader<u8, START_SRC_A>);
impl START_SRC_R {
    pub(crate) fn new(bits: u8) -> Self {
        START_SRC_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for START_SRC_R {
    type Target = crate::FieldReader<u8, START_SRC_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> START_SRC_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: START_SRC_A) -> &'a mut W {
