...
pub struct REG7_R(crate::FieldReader<u16, u16>);
impl REG7_R {
    pub(crate) fn new(bits: u16) -> Self {
        REG7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG7_R {
...
Internal. Only to be used through TI provided API."]
pub struct REG6_R(crate::FieldReader<u16, u16>);
impl REG6_R {
    pub(crate) fn new(bits: u16) -> Self {
        REG6_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG6_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
