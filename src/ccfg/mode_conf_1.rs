...
pub struct ALT_DCDC_VMIN_R(crate::FieldReader<u8, u8>);
impl ALT_DCDC_VMIN_R {
    pub(crate) fn new(bits: u8) -> Self {
        ALT_DCDC_VMIN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ALT_DCDC_VMIN_R {
...
pub struct ALT_DCDC_DITHER_EN_R(crate::FieldReader<bool, bool>);
impl ALT_DCDC_DITHER_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        ALT_DCDC_DITHER_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ALT_DCDC_DITHER_EN_R {
...
pub struct ALT_DCDC_IPEAK_R(crate::FieldReader<u8, u8>);
impl ALT_DCDC_IPEAK_R {
    pub(crate) fn new(bits: u8) -> Self {
        ALT_DCDC_IPEAK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ALT_DCDC_IPEAK_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DELTA_IBIAS_INIT_R(crate::FieldReader<u8, u8>);
impl DELTA_IBIAS_INIT_R {
    pub(crate) fn new(bits: u8) -> Self {
        DELTA_IBIAS_INIT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DELTA_IBIAS_INIT_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DELTA_IBIAS_OFFSET_R(crate::FieldReader<u8, u8>);
impl DELTA_IBIAS_OFFSET_R {
    pub(crate) fn new(bits: u8) -> Self {
        DELTA_IBIAS_OFFSET_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DELTA_IBIAS_OFFSET_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct XOSC_MAX_START_R(crate::FieldReader<u8, u8>);
impl XOSC_MAX_START_R {
    pub(crate) fn new(bits: u8) -> Self {
        XOSC_MAX_START_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for XOSC_MAX_START_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
