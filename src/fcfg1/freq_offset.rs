...
pub struct HPOSC_COMP_P0_R(crate::FieldReader<u16, u16>);
impl HPOSC_COMP_P0_R {
    pub(crate) fn new(bits: u16) -> Self {
        HPOSC_COMP_P0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HPOSC_COMP_P0_R {
...
Internal. Only to be used through TI provided API."]
pub struct HPOSC_COMP_P1_R(crate::FieldReader<u8, u8>);
impl HPOSC_COMP_P1_R {
    pub(crate) fn new(bits: u8) -> Self {
        HPOSC_COMP_P1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HPOSC_COMP_P1_R {
...
Internal. Only to be used through TI provided API."]
pub struct HPOSC_COMP_P2_R(crate::FieldReader<u8, u8>);
impl HPOSC_COMP_P2_R {
    pub(crate) fn new(bits: u8) -> Self {
        HPOSC_COMP_P2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HPOSC_COMP_P2_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
