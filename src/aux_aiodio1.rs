...
pub struct RegisterBlock {
    ...
    pub gpiodout: crate::Reg<gpiodout::GPIODOUT_SPEC>,
    ...
    pub iomode: crate::Reg<iomode::IOMODE_SPEC>,
    ...
    pub gpiodin: crate::Reg<gpiodin::GPIODIN_SPEC>,
    ...
    pub gpiodoutset: crate::Reg<gpiodoutset::GPIODOUTSET_SPEC>,
    ...
    pub gpiodoutclr: crate::Reg<gpiodoutclr::GPIODOUTCLR_SPEC>,
    ...
    pub gpiodouttgl: crate::Reg<gpiodouttgl::GPIODOUTTGL_SPEC>,
    ...
    pub gpiodie: crate::Reg<gpiodie::GPIODIE_SPEC>,
}
#[doc = "GPIODOUT register accessor: an alias for `Reg<GPIODOUT_SPEC>`"]
...
pub mod gpiodout;
#[doc = "IOMODE register accessor: an alias for `Reg<IOMODE_SPEC>`"]
...
pub mod iomode;
#[doc = "GPIODIN register accessor: an alias for `Reg<GPIODIN_SPEC>`"]
...
pub mod gpiodin;
#[doc = "GPIODOUTSET register accessor: an alias for `Reg<GPIODOUTSET_SPEC>`"]
...
pub mod gpiodoutset;
#[doc = "GPIODOUTCLR register accessor: an alias for `Reg<GPIODOUTCLR_SPEC>`"]
...
pub mod gpiodoutclr;
#[doc = "GPIODOUTTGL register accessor: an alias for `Reg<GPIODOUTTGL_SPEC>`"]
...
pub mod gpiodouttgl;
#[doc = "GPIODIE register accessor: an alias for `Reg<GPIODIE_SPEC>`"]
