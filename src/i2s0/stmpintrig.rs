...
pub struct IN_START_WCNT_R(crate::FieldReader<u16, u16>);
impl IN_START_WCNT_R {
    pub(crate) fn new(bits: u16) -> Self {
        IN_START_WCNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IN_START_WCNT_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
