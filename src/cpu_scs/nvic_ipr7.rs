...
pub struct PRI_31_R(crate::FieldReader<u8, u8>);
impl PRI_31_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRI_31_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRI_31_R {
...
pub struct PRI_30_R(crate::FieldReader<u8, u8>);
impl PRI_30_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRI_30_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRI_30_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct PRI_29_R(crate::FieldReader<u8, u8>);
impl PRI_29_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRI_29_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRI_29_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct PRI_28_R(crate::FieldReader<u8, u8>);
impl PRI_28_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRI_28_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRI_28_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
