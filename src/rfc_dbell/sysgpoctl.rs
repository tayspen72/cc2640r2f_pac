...
RF Core GPO control bit 3. Selects which signal to output on the RF Core GPO line 3."]
pub struct GPOCTL3_R(crate::FieldReader<u8, GPOCTL3_A>);
impl GPOCTL3_R {
    pub(crate) fn new(bits: u8) -> Self {
        GPOCTL3_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for GPOCTL3_R {
    type Target = crate::FieldReader<u8, GPOCTL3_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
RF Core GPO control bit 2. Selects which signal to output on the RF Core GPO line 2."]
pub struct GPOCTL2_R(crate::FieldReader<u8, GPOCTL2_A>);
impl GPOCTL2_R {
    pub(crate) fn new(bits: u8) -> Self {
        GPOCTL2_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for GPOCTL2_R {
    type Target = crate::FieldReader<u8, GPOCTL2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
RF Core GPO control bit 1. Selects which signal to output on the RF Core GPO line 1."]
pub struct GPOCTL1_R(crate::FieldReader<u8, GPOCTL1_A>);
impl GPOCTL1_R {
    pub(crate) fn new(bits: u8) -> Self {
        GPOCTL1_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for GPOCTL1_R {
    type Target = crate::FieldReader<u8, GPOCTL1_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
RF Core GPO control bit 0. Selects which signal to output on the RF Core GPO line 0."]
pub struct GPOCTL0_R(crate::FieldReader<u8, GPOCTL0_A>);
impl GPOCTL0_R {
    pub(crate) fn new(bits: u8) -> Self {
        GPOCTL0_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for GPOCTL0_R {
    type Target = crate::FieldReader<u8, GPOCTL0_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
