...
One-Shot/Periodic Interrupt Disable"]
pub struct TACINTD_R(crate::FieldReader<bool, TACINTD_A>);
impl TACINTD_R {
    pub(crate) fn new(bits: bool) -> Self {
        TACINTD_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for TACINTD_R {
    type Target = crate::FieldReader<bool, TACINTD_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPTM Timer A PWM Legacy Operation 0 Legacy operation with CCP pin driven Low when the TAILR register is reloaded after the timer reaches 0. 1 CCP is driven High when the TAILR register is reloaded after the timer reaches 0. This bit is only valid in PWM mode."]
pub struct TAPLO_R(crate::FieldReader<bool, TAPLO_A>);
impl TAPLO_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TAPLO_R {
    type Target = crate::FieldReader<bool, TAPLO_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
Timer A Match Register Update mode This bit defines when the TAMATCHR and TAPR registers are updated. If the timer is disabled (CTL.TAEN = 0) when this bit is set, TAMATCHR and TAPR are updated when the timer is enabled. If the timer is stalled (CTL.TASTALL = 1) when this bit is set, TAMATCHR and TAPR are updated according to the configuration of this bit."]
pub struct TAMRSU_R(crate::FieldReader<bool, TAMRSU_A>);
impl TAMRSU_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TAMRSU_R {
    type Target = crate::FieldReader<bool, TAMRSU_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPTM Timer A PWM Interrupt Enable This bit enables interrupts in PWM mode on rising, falling, or both edges of the CCP output, as defined by the CTL.TAEVENT In addition, when this bit is set and a capture event occurs, Timer A automatically generates triggers to the DMA if the trigger capability is enabled by setting the CTL.TAOTE bit and the DMAEV.CAEDMAEN bit respectively. 0 Capture event interrupt is disabled. 1 Capture event interrupt is enabled. This bit is only valid in PWM mode."]
pub struct TAPWMIE_R(crate::FieldReader<bool, TAPWMIE_A>);
impl TAPWMIE_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TAPWMIE_R {
    type Target = crate::FieldReader<bool, TAPWMIE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPT Timer A PWM Interval Load Write"]
pub struct TAILD_R(crate::FieldReader<bool, TAILD_A>);
impl TAILD_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TAILD_R {
    type Target = crate::FieldReader<bool, TAILD_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPT Timer A Snap-Shot Mode"]
pub struct TASNAPS_R(crate::FieldReader<bool, TASNAPS_A>);
impl TASNAPS_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TASNAPS_R {
    type Target = crate::FieldReader<bool, TASNAPS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPT Timer A Wait-On-Trigger"]
pub struct TAWOT_R(crate::FieldReader<bool, TAWOT_A>);
impl TAWOT_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TAWOT_R {
    type Target = crate::FieldReader<bool, TAWOT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPT Timer A Match Interrupt Enable"]
pub struct TAMIE_R(crate::FieldReader<bool, TAMIE_A>);
impl TAMIE_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TAMIE_R {
    type Target = crate::FieldReader<bool, TAMIE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPT Timer A Count Direction"]
pub struct TACDIR_R(crate::FieldReader<bool, TACDIR_A>);
impl TACDIR_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TACDIR_R {
    type Target = crate::FieldReader<bool, TACDIR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPT Timer A Alternate Mode Note: To enable PWM mode, you must also clear TACM and then configure TAMR field to 0x2."]
pub struct TAAMS_R(crate::FieldReader<bool, TAAMS_A>);
impl TAAMS_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TAAMS_R {
    type Target = crate::FieldReader<bool, TAAMS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPT Timer A Capture Mode"]
pub struct TACM_R(crate::FieldReader<bool, TACM_A>);
impl TACM_R {
    pub(crate) fn new(bits: bool) -> Self {
        TACM_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for TACM_R {
    type Target = crate::FieldReader<bool, TACM_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
GPT Timer A Mode 0x0 Reserved 0x1 One-Shot Timer mode 0x2 Periodic Timer mode 0x3 Capture mode The Timer mode is based on the timer configuration defined by bits 2:0 in the CFG register"]
pub struct TAMR_R(crate::FieldReader<u8, TAMR_A>);
impl TAMR_R {
    pub(crate) fn new(bits: u8) -> Self {
...
impl core::ops::Deref for TAMR_R {
    type Target = crate::FieldReader<u8, TAMR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
