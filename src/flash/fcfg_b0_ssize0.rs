...
Internal. Only to be used through TI provided API."]
pub struct B0_NUM_SECTORS_R(crate::FieldReader<u16, u16>);
impl B0_NUM_SECTORS_R {
    pub(crate) fn new(bits: u16) -> Self {
        B0_NUM_SECTORS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for B0_NUM_SECTORS_R {
...
Internal. Only to be used through TI provided API."]
pub struct B0_SECT_SIZE_R(crate::FieldReader<u8, u8>);
impl B0_SECT_SIZE_R {
    pub(crate) fn new(bits: u8) -> Self {
        B0_SECT_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for B0_SECT_SIZE_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
