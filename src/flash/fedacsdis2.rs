...
pub struct SECTORID2_R(crate::FieldReader<u32, u32>);
impl SECTORID2_R {
    pub(crate) fn new(bits: u32) -> Self {
        SECTORID2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SECTORID2_R {
...
Internal. Only to be used through TI provided API."]
pub struct SECTORID2_W<'a> {
    w: &'a mut W,
}
impl<'a> SECTORID2_W<'a> {
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn sectorid2(&self) -> SECTORID2_R {
        SECTORID2_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn sectorid2(&mut self) -> SECTORID2_W {
        SECTORID2_W { w: self }
    }
