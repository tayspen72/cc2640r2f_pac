...
Internal. Only to be used through TI provided API."]
pub struct BEG_EC_LEVEL_R(crate::FieldReader<u8, u8>);
impl BEG_EC_LEVEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        BEG_EC_LEVEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BEG_EC_LEVEL_R {
...
Internal. Only to be used through TI provided API."]
pub struct MAX_PRG_PUL_R(crate::FieldReader<u16, u16>);
impl MAX_PRG_PUL_R {
    pub(crate) fn new(bits: u16) -> Self {
        MAX_PRG_PUL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MAX_PRG_PUL_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
