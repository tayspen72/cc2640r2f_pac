...
pub struct LEN_LSW_R(crate::FieldReader<u32, u32>);
impl LEN_LSW_R {
    pub(crate) fn new(bits: u32) -> Self {
        LEN_LSW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LEN_LSW_R {
...
of the combined data length."]
    ...
    pub fn len_lsw(&self) -> LEN_LSW_R {
        LEN_LSW_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
