...
pub struct ERASE_PW_R(crate::FieldReader<u32, u32>);
impl ERASE_PW_R {
    pub(crate) fn new(bits: u32) -> Self {
        ERASE_PW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ERASE_PW_R {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn erase_pw(&mut self) -> ERASE_PW_W {
        ERASE_PW_W { w: self }
    }
