...
pub struct PRI_10_R(crate::FieldReader<u8, u8>);
impl PRI_10_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRI_10_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRI_10_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct PRI_9_R(crate::FieldReader<u8, u8>);
impl PRI_9_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRI_9_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRI_9_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct PRI_8_R(crate::FieldReader<u8, u8>);
impl PRI_8_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRI_8_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRI_8_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
