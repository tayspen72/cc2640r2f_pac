...
Internal. Only to be used through TI provided API."]
pub struct PGM_VH_R(crate::FieldReader<u8, u8>);
impl PGM_VH_R {
    pub(crate) fn new(bits: u8) -> Self {
        PGM_VH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PGM_VH_R {
...
Internal. Only to be used through TI provided API."]
pub struct ERA_VH_R(crate::FieldReader<u8, u8>);
impl ERA_VH_R {
    pub(crate) fn new(bits: u8) -> Self {
        ERA_VH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ERA_VH_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
