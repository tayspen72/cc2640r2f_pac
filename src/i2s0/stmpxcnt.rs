...
pub struct CURR_VALUE_R(crate::FieldReader<u16, u16>);
impl CURR_VALUE_R {
    pub(crate) fn new(bits: u16) -> Self {
        CURR_VALUE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CURR_VALUE_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
Current value of the XOSC counter, latched when reading STMPWCNT."]
pub struct CURR_VALUE_W<'a> {
    w: &'a mut W,
}
impl<'a> CURR_VALUE_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
Current value of the XOSC counter, latched when reading STMPWCNT."]
    #[inline(always)]
    pub fn curr_value(&mut self) -> CURR_VALUE_W {
        CURR_VALUE_W { w: self }
    }
