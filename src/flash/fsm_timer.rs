...
pub struct FSM_TIMER_R(crate::FieldReader<u32, u32>);
impl FSM_TIMER_R {
    pub(crate) fn new(bits: u32) -> Self {
        FSM_TIMER_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FSM_TIMER_R {
...
Internal. Only to be used through TI provided API."]
pub struct FSM_TIMER_W<'a> {
    w: &'a mut W,
}
impl<'a> FSM_TIMER_W<'a> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn fsm_timer(&mut self) -> FSM_TIMER_W {
        FSM_TIMER_W { w: self }
    }
