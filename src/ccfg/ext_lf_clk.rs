...
pub struct DIO_R(crate::FieldReader<u8, u8>);
impl DIO_R {
    pub(crate) fn new(bits: u8) -> Self {
        DIO_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DIO_R {
...
pub struct RTC_INCREMENT_R(crate::FieldReader<u32, u32>);
impl RTC_INCREMENT_R {
    pub(crate) fn new(bits: u32) -> Self {
        RTC_INCREMENT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RTC_INCREMENT_R {
