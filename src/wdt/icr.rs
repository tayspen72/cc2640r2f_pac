...
pub struct WDTICR_R(crate::FieldReader<u32, u32>);
impl WDTICR_R {
    pub(crate) fn new(bits: u32) -> Self {
        WDTICR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WDTICR_R {
...
This register is the interrupt clear register. A write of any value to this register clears the WDT interrupt and reloads the 32-bit counter from the LOAD register."]
    ...
    pub fn wdticr(&self) -> WDTICR_R {
        WDTICR_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
