...
pub struct FRAW_DATAL_R(crate::FieldReader<u32, u32>);
impl FRAW_DATAL_R {
    pub(crate) fn new(bits: u32) -> Self {
        FRAW_DATAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAW_DATAL_R {
...
Internal. Only to be used through TI provided API."]
pub struct FRAW_DATAL_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAW_DATAL_W<'a> {
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn fraw_datal(&self) -> FRAW_DATAL_R {
        FRAW_DATAL_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn fraw_datal(&mut self) -> FRAW_DATAL_W {
        FRAW_DATAL_W { w: self }
    }
