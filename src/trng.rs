...
pub struct RegisterBlock {
    ...
    pub out0: crate::Reg<out0::OUT0_SPEC>,
    #[doc = "0x04 - Random Number Upper Word Readout Value"]
    pub out1: crate::Reg<out1::OUT1_SPEC>,
    #[doc = "0x08 - Interrupt Status"]
    pub irqflagstat: crate::Reg<irqflagstat::IRQFLAGSTAT_SPEC>,
    #[doc = "0x0c - Interrupt Mask"]
    pub irqflagmask: crate::Reg<irqflagmask::IRQFLAGMASK_SPEC>,
    #[doc = "0x10 - Interrupt Flag Clear"]
    pub irqflagclr: crate::Reg<irqflagclr::IRQFLAGCLR_SPEC>,
    #[doc = "0x14 - Control"]
    pub ctl: crate::Reg<ctl::CTL_SPEC>,
    #[doc = "0x18 - Configuration 0"]
    pub cfg0: crate::Reg<cfg0::CFG0_SPEC>,
    #[doc = "0x1c - Alarm Control"]
    pub alarmcnt: crate::Reg<alarmcnt::ALARMCNT_SPEC>,
    #[doc = "0x20 - FRO Enable"]
    pub froen: crate::Reg<froen::FROEN_SPEC>,
    #[doc = "0x24 - FRO De-tune Bit"]
    pub frodetune: crate::Reg<frodetune::FRODETUNE_SPEC>,
    #[doc = "0x28 - Alarm Event"]
    pub alarmmask: crate::Reg<alarmmask::ALARMMASK_SPEC>,
    #[doc = "0x2c - Alarm Shutdown"]
    pub alarmstop: crate::Reg<alarmstop::ALARMSTOP_SPEC>,
    #[doc = "0x30 - LFSR Readout Value"]
    pub lfsr0: crate::Reg<lfsr0::LFSR0_SPEC>,
    #[doc = "0x34 - LFSR Readout Value"]
    pub lfsr1: crate::Reg<lfsr1::LFSR1_SPEC>,
    #[doc = "0x38 - LFSR Readout Value"]
    pub lfsr2: crate::Reg<lfsr2::LFSR2_SPEC>,
    _reserved15: [u8; 0x3c],
    #[doc = "0x78 - TRNG Engine Options Information"]
    pub hwopt: crate::Reg<hwopt::HWOPT_SPEC>,
    #[doc = "0x7c - HW Version 0 EIP Number And Core Revision"]
    pub hwver0: crate::Reg<hwver0::HWVER0_SPEC>,
    _reserved17: [u8; 0x1f58],
    #[doc = "0x1fd8 - Interrupt Status After Masking"]
    pub irqstatmask: crate::Reg<irqstatmask::IRQSTATMASK_SPEC>,
    _reserved18: [u8; 0x04],
    #[doc = "0x1fe0 - HW Version 1 TRNG Revision Number"]
    pub hwver1: crate::Reg<hwver1::HWVER1_SPEC>,
    _reserved19: [u8; 0x08],
...
#[doc = "OUT0 register accessor: an alias for `Reg<OUT0_SPEC>`"]
...
pub mod out1;
#[doc = "IRQFLAGSTAT register accessor: an alias for `Reg<IRQFLAGSTAT_SPEC>`"]
pub type IRQFLAGSTAT = crate::Reg<irqflagstat::IRQFLAGSTAT_SPEC>;
#[doc = "Interrupt Status"]
pub mod irqflagstat;
#[doc = "IRQFLAGMASK register accessor: an alias for `Reg<IRQFLAGMASK_SPEC>`"]
pub type IRQFLAGMASK = crate::Reg<irqflagmask::IRQFLAGMASK_SPEC>;
#[doc = "Interrupt Mask"]
pub mod irqflagmask;
#[doc = "IRQFLAGCLR register accessor: an alias for `Reg<IRQFLAGCLR_SPEC>`"]
...
#[doc = "Configuration 0"]
pub mod cfg0;
#[doc = "ALARMCNT register accessor: an alias for `Reg<ALARMCNT_SPEC>`"]
pub type ALARMCNT = crate::Reg<alarmcnt::ALARMCNT_SPEC>;
#[doc = "Alarm Control"]
pub mod alarmcnt;
#[doc = "FROEN register accessor: an alias for `Reg<FROEN_SPEC>`"]
pub type FROEN = crate::Reg<froen::FROEN_SPEC>;
#[doc = "FRO Enable"]
pub mod froen;
#[doc = "FRODETUNE register accessor: an alias for `Reg<FRODETUNE_SPEC>`"]
pub type FRODETUNE = crate::Reg<frodetune::FRODETUNE_SPEC>;
#[doc = "FRO De-tune Bit"]
pub mod frodetune;
#[doc = "ALARMMASK register accessor: an alias for `Reg<ALARMMASK_SPEC>`"]
pub type ALARMMASK = crate::Reg<alarmmask::ALARMMASK_SPEC>;
#[doc = "Alarm Event"]
pub mod alarmmask;
#[doc = "ALARMSTOP register accessor: an alias for `Reg<ALARMSTOP_SPEC>`"]
pub type ALARMSTOP = crate::Reg<alarmstop::ALARMSTOP_SPEC>;
#[doc = "Alarm Shutdown"]
pub mod alarmstop;
#[doc = "LFSR0 register accessor: an alias for `Reg<LFSR0_SPEC>`"]
pub type LFSR0 = crate::Reg<lfsr0::LFSR0_SPEC>;
#[doc = "LFSR Readout Value"]
pub mod lfsr0;
#[doc = "LFSR1 register accessor: an alias for `Reg<LFSR1_SPEC>`"]
pub type LFSR1 = crate::Reg<lfsr1::LFSR1_SPEC>;
#[doc = "LFSR Readout Value"]
pub mod lfsr1;
#[doc = "LFSR2 register accessor: an alias for `Reg<LFSR2_SPEC>`"]
pub type LFSR2 = crate::Reg<lfsr2::LFSR2_SPEC>;
#[doc = "LFSR Readout Value"]
pub mod lfsr2;
#[doc = "HWOPT register accessor: an alias for `Reg<HWOPT_SPEC>`"]
pub type HWOPT = crate::Reg<hwopt::HWOPT_SPEC>;
#[doc = "TRNG Engine Options Information"]
pub mod hwopt;
#[doc = "HWVER0 register accessor: an alias for `Reg<HWVER0_SPEC>`"]
pub type HWVER0 = crate::Reg<hwver0::HWVER0_SPEC>;
#[doc = "HW Version 0 EIP Number And Core Revision"]
pub mod hwver0;
#[doc = "IRQSTATMASK register accessor: an alias for `Reg<IRQSTATMASK_SPEC>`"]
pub type IRQSTATMASK = crate::Reg<irqstatmask::IRQSTATMASK_SPEC>;
#[doc = "Interrupt Status After Masking"]
pub mod irqstatmask;
#[doc = "HWVER1 register accessor: an alias for `Reg<HWVER1_SPEC>`"]
