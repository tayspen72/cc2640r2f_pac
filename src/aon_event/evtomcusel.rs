...
Event selector for AON_PROG2 event. AON Event Source id# selecting event routed to EVENT as AON_PROG2 event."]
pub struct AON_PROG2_EV_R(crate::FieldReader<u8, AON_PROG2_EV_A>);
impl AON_PROG2_EV_R {
    pub(crate) fn new(bits: u8) -> Self {
        AON_PROG2_EV_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for AON_PROG2_EV_R {
    type Target = crate::FieldReader<u8, AON_PROG2_EV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
Event selector for AON_PROG1 event. AON Event Source id# selecting event routed to EVENT as AON_PROG1 event."]
pub struct AON_PROG1_EV_R(crate::FieldReader<u8, AON_PROG1_EV_A>);
impl AON_PROG1_EV_R {
    pub(crate) fn new(bits: u8) -> Self {
        AON_PROG1_EV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for AON_PROG1_EV_R {
    type Target = crate::FieldReader<u8, AON_PROG1_EV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
Event selector for AON_PROG0 event. AON Event Source id# selecting event routed to EVENT as AON_PROG0 event."]
pub struct AON_PROG0_EV_R(crate::FieldReader<u8, AON_PROG0_EV_A>);
impl AON_PROG0_EV_R {
    pub(crate) fn new(bits: u8) -> Self {
        AON_PROG0_EV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for AON_PROG0_EV_R {
    type Target = crate::FieldReader<u8, AON_PROG0_EV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
