...
pub mod cfg;
#[doc = "SYSCODE_START register accessor: an alias for `Reg<SYSCODE_START_SPEC>`"]
pub type SYSCODE_START = crate::Reg<syscode_start::SYSCODE_START_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod syscode_start;
#[doc = "FLASH_SIZE register accessor: an alias for `Reg<FLASH_SIZE_SPEC>`"]
pub type FLASH_SIZE = crate::Reg<flash_size::FLASH_SIZE_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod flash_size;
#[doc = "FWLOCK register accessor: an alias for `Reg<FWLOCK_SPEC>`"]
pub type FWLOCK = crate::Reg<fwlock::FWLOCK_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fwlock;
#[doc = "FWFLAG register accessor: an alias for `Reg<FWFLAG_SPEC>`"]
pub type FWFLAG = crate::Reg<fwflag::FWFLAG_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fwflag;
#[doc = "EFUSE register accessor: an alias for `Reg<EFUSE_SPEC>`"]
pub type EFUSE = crate::Reg<efuse::EFUSE_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efuse;
#[doc = "EFUSEADDR register accessor: an alias for `Reg<EFUSEADDR_SPEC>`"]
pub type EFUSEADDR = crate::Reg<efuseaddr::EFUSEADDR_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efuseaddr;
#[doc = "DATAUPPER register accessor: an alias for `Reg<DATAUPPER_SPEC>`"]
pub type DATAUPPER = crate::Reg<dataupper::DATAUPPER_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod dataupper;
#[doc = "DATALOWER register accessor: an alias for `Reg<DATALOWER_SPEC>`"]
pub type DATALOWER = crate::Reg<datalower::DATALOWER_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod datalower;
#[doc = "EFUSECFG register accessor: an alias for `Reg<EFUSECFG_SPEC>`"]
pub type EFUSECFG = crate::Reg<efusecfg::EFUSECFG_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efusecfg;
#[doc = "EFUSESTAT register accessor: an alias for `Reg<EFUSESTAT_SPEC>`"]
...
#[doc = "Internal. Only to be used through TI provided API."]
pub mod acc;
#[doc = "BOUNDARY register accessor: an alias for `Reg<BOUNDARY_SPEC>`"]
pub type BOUNDARY = crate::Reg<boundary::BOUNDARY_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod boundary;
#[doc = "EFUSEFLAG register accessor: an alias for `Reg<EFUSEFLAG_SPEC>`"]
pub type EFUSEFLAG = crate::Reg<efuseflag::EFUSEFLAG_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efuseflag;
#[doc = "EFUSEKEY register accessor: an alias for `Reg<EFUSEKEY_SPEC>`"]
pub type EFUSEKEY = crate::Reg<efusekey::EFUSEKEY_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efusekey;
#[doc = "EFUSERELEASE register accessor: an alias for `Reg<EFUSERELEASE_SPEC>`"]
pub type EFUSERELEASE = crate::Reg<efuserelease::EFUSERELEASE_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efuserelease;
#[doc = "EFUSEPINS register accessor: an alias for `Reg<EFUSEPINS_SPEC>`"]
pub type EFUSEPINS = crate::Reg<efusepins::EFUSEPINS_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efusepins;
#[doc = "EFUSECRA register accessor: an alias for `Reg<EFUSECRA_SPEC>`"]
pub type EFUSECRA = crate::Reg<efusecra::EFUSECRA_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efusecra;
#[doc = "EFUSEREAD register accessor: an alias for `Reg<EFUSEREAD_SPEC>`"]
pub type EFUSEREAD = crate::Reg<efuseread::EFUSEREAD_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efuseread;
#[doc = "EFUSEPROGRAM register accessor: an alias for `Reg<EFUSEPROGRAM_SPEC>`"]
pub type EFUSEPROGRAM = crate::Reg<efuseprogram::EFUSEPROGRAM_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efuseprogram;
#[doc = "EFUSEERROR register accessor: an alias for `Reg<EFUSEERROR_SPEC>`"]
pub type EFUSEERROR = crate::Reg<efuseerror::EFUSEERROR_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod efuseerror;
#[doc = "SINGLEBIT register accessor: an alias for `Reg<SINGLEBIT_SPEC>`"]
pub type SINGLEBIT = crate::Reg<singlebit::SINGLEBIT_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod singlebit;
#[doc = "TWOBIT register accessor: an alias for `Reg<TWOBIT_SPEC>`"]
pub type TWOBIT = crate::Reg<twobit::TWOBIT_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod twobit;
#[doc = "SELFTESTCYC register accessor: an alias for `Reg<SELFTESTCYC_SPEC>`"]
pub type SELFTESTCYC = crate::Reg<selftestcyc::SELFTESTCYC_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod selftestcyc;
#[doc = "SELFTESTSIGN register accessor: an alias for `Reg<SELFTESTSIGN_SPEC>`"]
pub type SELFTESTSIGN = crate::Reg<selftestsign::SELFTESTSIGN_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod selftestsign;
#[doc = "FRDCTL register accessor: an alias for `Reg<FRDCTL_SPEC>`"]
pub type FRDCTL = crate::Reg<frdctl::FRDCTL_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod frdctl;
#[doc = "FSPRD register accessor: an alias for `Reg<FSPRD_SPEC>`"]
pub type FSPRD = crate::Reg<fsprd::FSPRD_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fsprd;
#[doc = "FEDACCTL1 register accessor: an alias for `Reg<FEDACCTL1_SPEC>`"]
pub type FEDACCTL1 = crate::Reg<fedacctl1::FEDACCTL1_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fedacctl1;
#[doc = "FEDACCTL2 register accessor: an alias for `Reg<FEDACCTL2_SPEC>`"]
pub type FEDACCTL2 = crate::Reg<fedacctl2::FEDACCTL2_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fedacctl2;
#[doc = "FCOR_ERR_CNT register accessor: an alias for `Reg<FCOR_ERR_CNT_SPEC>`"]
pub type FCOR_ERR_CNT = crate::Reg<fcor_err_cnt::FCOR_ERR_CNT_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fcor_err_cnt;
#[doc = "FCOR_ERR_ADD register accessor: an alias for `Reg<FCOR_ERR_ADD_SPEC>`"]
pub type FCOR_ERR_ADD = crate::Reg<fcor_err_add::FCOR_ERR_ADD_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fcor_err_add;
#[doc = "FCOR_ERR_POS register accessor: an alias for `Reg<FCOR_ERR_POS_SPEC>`"]
pub type FCOR_ERR_POS = crate::Reg<fcor_err_pos::FCOR_ERR_POS_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fcor_err_pos;
#[doc = "FEDACSTAT register accessor: an alias for `Reg<FEDACSTAT_SPEC>`"]
pub type FEDACSTAT = crate::Reg<fedacstat::FEDACSTAT_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fedacstat;
#[doc = "FUNC_ERR_ADD register accessor: an alias for `Reg<FUNC_ERR_ADD_SPEC>`"]
pub type FUNC_ERR_ADD = crate::Reg<func_err_add::FUNC_ERR_ADD_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod func_err_add;
#[doc = "FEDACSDIS register accessor: an alias for `Reg<FEDACSDIS_SPEC>`"]
pub type FEDACSDIS = crate::Reg<fedacsdis::FEDACSDIS_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fedacsdis;
#[doc = "FPRIM_ADD_TAG register accessor: an alias for `Reg<FPRIM_ADD_TAG_SPEC>`"]
pub type FPRIM_ADD_TAG = crate::Reg<fprim_add_tag::FPRIM_ADD_TAG_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fprim_add_tag;
#[doc = "FREDU_ADD_TAG register accessor: an alias for `Reg<FREDU_ADD_TAG_SPEC>`"]
pub type FREDU_ADD_TAG = crate::Reg<fredu_add_tag::FREDU_ADD_TAG_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fredu_add_tag;
#[doc = "FBPROT register accessor: an alias for `Reg<FBPROT_SPEC>`"]
pub type FBPROT = crate::Reg<fbprot::FBPROT_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fbprot;
#[doc = "FBSE register accessor: an alias for `Reg<FBSE_SPEC>`"]
pub type FBSE = crate::Reg<fbse::FBSE_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fbse;
#[doc = "FBBUSY register accessor: an alias for `Reg<FBBUSY_SPEC>`"]
pub type FBBUSY = crate::Reg<fbbusy::FBBUSY_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fbbusy;
#[doc = "FBAC register accessor: an alias for `Reg<FBAC_SPEC>`"]
pub type FBAC = crate::Reg<fbac::FBAC_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fbac;
#[doc = "FBFALLBACK register accessor: an alias for `Reg<FBFALLBACK_SPEC>`"]
pub type FBFALLBACK = crate::Reg<fbfallback::FBFALLBACK_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fbfallback;
#[doc = "FBPRDY register accessor: an alias for `Reg<FBPRDY_SPEC>`"]
pub type FBPRDY = crate::Reg<fbprdy::FBPRDY_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fbprdy;
#[doc = "FPAC1 register accessor: an alias for `Reg<FPAC1_SPEC>`"]
pub type FPAC1 = crate::Reg<fpac1::FPAC1_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fpac1;
#[doc = "FPAC2 register accessor: an alias for `Reg<FPAC2_SPEC>`"]
pub type FPAC2 = crate::Reg<fpac2::FPAC2_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fpac2;
#[doc = "FMAC register accessor: an alias for `Reg<FMAC_SPEC>`"]
...
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fmstat;
#[doc = "FEMU_DMSW register accessor: an alias for `Reg<FEMU_DMSW_SPEC>`"]
pub type FEMU_DMSW = crate::Reg<femu_dmsw::FEMU_DMSW_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod femu_dmsw;
#[doc = "FEMU_DLSW register accessor: an alias for `Reg<FEMU_DLSW_SPEC>`"]
pub type FEMU_DLSW = crate::Reg<femu_dlsw::FEMU_DLSW_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod femu_dlsw;
#[doc = "FEMU_ECC register accessor: an alias for `Reg<FEMU_ECC_SPEC>`"]
pub type FEMU_ECC = crate::Reg<femu_ecc::FEMU_ECC_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod femu_ecc;
#[doc = "FLOCK register accessor: an alias for `Reg<FLOCK_SPEC>`"]
pub type FLOCK = crate::Reg<flock::FLOCK_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod flock;
#[doc = "FEMU_ADDR register accessor: an alias for `Reg<FEMU_ADDR_SPEC>`"]
pub type FEMU_ADDR = crate::Reg<femu_addr::FEMU_ADDR_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod femu_addr;
#[doc = "FDIAGCTL register accessor: an alias for `Reg<FDIAGCTL_SPEC>`"]
pub type FDIAGCTL = crate::Reg<fdiagctl::FDIAGCTL_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fdiagctl;
#[doc = "FRAW_DATAH register accessor: an alias for `Reg<FRAW_DATAH_SPEC>`"]
pub type FRAW_DATAH = crate::Reg<fraw_datah::FRAW_DATAH_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fraw_datah;
#[doc = "FRAW_DATAL register accessor: an alias for `Reg<FRAW_DATAL_SPEC>`"]
pub type FRAW_DATAL = crate::Reg<fraw_datal::FRAW_DATAL_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fraw_datal;
#[doc = "FRAW_ECC register accessor: an alias for `Reg<FRAW_ECC_SPEC>`"]
pub type FRAW_ECC = crate::Reg<fraw_ecc::FRAW_ECC_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fraw_ecc;
#[doc = "FPAR_OVR register accessor: an alias for `Reg<FPAR_OVR_SPEC>`"]
pub type FPAR_OVR = crate::Reg<fpar_ovr::FPAR_OVR_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fpar_ovr;
#[doc = "FVREADCT register accessor: an alias for `Reg<FVREADCT_SPEC>`"]
pub type FVREADCT = crate::Reg<fvreadct::FVREADCT_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fvreadct;
#[doc = "FVHVCT1 register accessor: an alias for `Reg<FVHVCT1_SPEC>`"]
pub type FVHVCT1 = crate::Reg<fvhvct1::FVHVCT1_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fvhvct1;
#[doc = "FVHVCT2 register accessor: an alias for `Reg<FVHVCT2_SPEC>`"]
pub type FVHVCT2 = crate::Reg<fvhvct2::FVHVCT2_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fvhvct2;
#[doc = "FVHVCT3 register accessor: an alias for `Reg<FVHVCT3_SPEC>`"]
pub type FVHVCT3 = crate::Reg<fvhvct3::FVHVCT3_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fvhvct3;
#[doc = "FVNVCT register accessor: an alias for `Reg<FVNVCT_SPEC>`"]
pub type FVNVCT = crate::Reg<fvnvct::FVNVCT_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fvnvct;
#[doc = "FVSLP register accessor: an alias for `Reg<FVSLP_SPEC>`"]
pub type FVSLP = crate::Reg<fvslp::FVSLP_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fvslp;
#[doc = "FVWLCT register accessor: an alias for `Reg<FVWLCT_SPEC>`"]
pub type FVWLCT = crate::Reg<fvwlct::FVWLCT_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fvwlct;
#[doc = "FEFUSECTL register accessor: an alias for `Reg<FEFUSECTL_SPEC>`"]
pub type FEFUSECTL = crate::Reg<fefusectl::FEFUSECTL_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fefusectl;
#[doc = "FEFUSESTAT register accessor: an alias for `Reg<FEFUSESTAT_SPEC>`"]
pub type FEFUSESTAT = crate::Reg<fefusestat::FEFUSESTAT_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fefusestat;
#[doc = "FEFUSEDATA register accessor: an alias for `Reg<FEFUSEDATA_SPEC>`"]
pub type FEFUSEDATA = crate::Reg<fefusedata::FEFUSEDATA_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fefusedata;
#[doc = "FSEQPMP register accessor: an alias for `Reg<FSEQPMP_SPEC>`"]
pub type FSEQPMP = crate::Reg<fseqpmp::FSEQPMP_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fseqpmp;
#[doc = "FCLKTRIM register accessor: an alias for `Reg<FCLKTRIM_SPEC>`"]
pub type FCLKTRIM = crate::Reg<fclktrim::FCLKTRIM_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fclktrim;
#[doc = "ROM_TEST register accessor: an alias for `Reg<ROM_TEST_SPEC>`"]
pub type ROM_TEST = crate::Reg<rom_test::ROM_TEST_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod rom_test;
#[doc = "FEDACSDIS2 register accessor: an alias for `Reg<FEDACSDIS2_SPEC>`"]
pub type FEDACSDIS2 = crate::Reg<fedacsdis2::FEDACSDIS2_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fedacsdis2;
#[doc = "FBSTROBES register accessor: an alias for `Reg<FBSTROBES_SPEC>`"]
pub type FBSTROBES = crate::Reg<fbstrobes::FBSTROBES_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fbstrobes;
#[doc = "FPSTROBES register accessor: an alias for `Reg<FPSTROBES_SPEC>`"]
pub type FPSTROBES = crate::Reg<fpstrobes::FPSTROBES_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fpstrobes;
#[doc = "FBMODE register accessor: an alias for `Reg<FBMODE_SPEC>`"]
pub type FBMODE = crate::Reg<fbmode::FBMODE_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fbmode;
#[doc = "FTCR register accessor: an alias for `Reg<FTCR_SPEC>`"]
