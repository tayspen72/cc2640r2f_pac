...
Internal. Only to be used through TI provided API."]
pub struct PROG_PUL_WIDTH_R(crate::FieldReader<u16, u16>);
impl PROG_PUL_WIDTH_R {
    pub(crate) fn new(bits: u16) -> Self {
        PROG_PUL_WIDTH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PROG_PUL_WIDTH_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
