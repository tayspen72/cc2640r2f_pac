...
Internal. Only to be used through TI provided API."]
pub struct COMPA_IN_R(crate::FieldReader<u8, COMPA_IN_A>);
impl COMPA_IN_R {
    pub(crate) fn new(bits: u8) -> Self {
        COMPA_IN_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for COMPA_IN_R {
    type Target = crate::FieldReader<u8, COMPA_IN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
