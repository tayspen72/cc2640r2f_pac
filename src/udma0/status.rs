...
pub struct TOTALCHANNELS_R(crate::FieldReader<u8, u8>);
impl TOTALCHANNELS_R {
    pub(crate) fn new(bits: u8) -> Self {
        TOTALCHANNELS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TOTALCHANNELS_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
