...
MCU Wakeup Source #3 AON Event Source selecting 1 of 4 events routed to AON_WUC for waking up the MCU domain from Power Off or Power Down. Note:"]
pub struct WU3_EV_R(crate::FieldReader<u8, WU3_EV_A>);
impl WU3_EV_R {
    pub(crate) fn new(bits: u8) -> Self {
        WU3_EV_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for WU3_EV_R {
    type Target = crate::FieldReader<u8, WU3_EV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> WU3_EV_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: WU3_EV_A) -> &'a mut W {
...
MCU Wakeup Source #2 AON Event Source selecting 1 of 4 events routed to AON_WUC for waking up the MCU domain from Power Off or Power Down. Note:"]
pub struct WU2_EV_R(crate::FieldReader<u8, WU2_EV_A>);
impl WU2_EV_R {
    pub(crate) fn new(bits: u8) -> Self {
        WU2_EV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for WU2_EV_R {
    type Target = crate::FieldReader<u8, WU2_EV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> WU2_EV_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: WU2_EV_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "No event, always low"]
    #[inline(always)]
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub struct RESERVED14_R(crate::FieldReader<u8, u8>);
impl RESERVED14_R {
    pub(crate) fn new(bits: u8) -> Self {
...
MCU Wakeup Source #1 AON Event Source selecting 1 of 4 events routed to AON_WUC for waking up the MCU domain from Power Off or Power Down. Note:"]
pub struct WU1_EV_R(crate::FieldReader<u8, WU1_EV_A>);
impl WU1_EV_R {
    pub(crate) fn new(bits: u8) -> Self {
        WU1_EV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for WU1_EV_R {
    type Target = crate::FieldReader<u8, WU1_EV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> WU1_EV_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: WU1_EV_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "No event, always low"]
    #[inline(always)]
...
MCU Wakeup Source #0 AON Event Source selecting 1 of 4 events routed to AON_WUC for waking up the MCU domain from Power Off or Power Down. Note:"]
pub struct WU0_EV_R(crate::FieldReader<u8, WU0_EV_A>);
impl WU0_EV_R {
    pub(crate) fn new(bits: u8) -> Self {
        WU0_EV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for WU0_EV_R {
    type Target = crate::FieldReader<u8, WU0_EV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> WU0_EV_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: WU0_EV_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "No event, always low"]
    #[inline(always)]
