...
AON Event Source id# for RTCSEL event which is fed to AON_RTC. Please refer to AON_RTC:CH1CAPT"]
pub struct RTC_CH1_CAPT_EV_R(crate::FieldReader<u8, RTC_CH1_CAPT_EV_A>);
impl RTC_CH1_CAPT_EV_R {
    pub(crate) fn new(bits: u8) -> Self {
        RTC_CH1_CAPT_EV_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for RTC_CH1_CAPT_EV_R {
    type Target = crate::FieldReader<u8, RTC_CH1_CAPT_EV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
