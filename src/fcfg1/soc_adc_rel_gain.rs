...
pub struct SOC_ADC_REL_GAIN_TEMP1_R(crate::FieldReader<u16, u16>);
impl SOC_ADC_REL_GAIN_TEMP1_R {
    pub(crate) fn new(bits: u16) -> Self {
        SOC_ADC_REL_GAIN_TEMP1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SOC_ADC_REL_GAIN_TEMP1_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
