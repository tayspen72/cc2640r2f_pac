...
Select event source to connect to AUX_SCE:WUSTAT.EV_SIGNALS bit 7."]
pub struct WEV7_EV_R(crate::FieldReader<u8, WEV7_EV_A>);
impl WEV7_EV_R {
    pub(crate) fn new(bits: u8) -> Self {
        WEV7_EV_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for WEV7_EV_R {
    type Target = crate::FieldReader<u8, WEV7_EV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> WEV7_EV_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: WEV7_EV_A) -> &'a mut W {
